...
(Esta é uma seção de modelo. Você deve preencher com os comandos reais para rodar o projeto.)
...
Navegue até o diretório do backend (/backend ou similar).

Configure as credenciais do seu banco de dados MySQL no arquivo application.properties (ou application.yml).
...
Navegue até o diretório do frontend (/frontend ou similar).
